...
public class FighterPatrol : StateMachineBehaviour
{
    ...
    {
        Collider2D hit = Physics2D.OverlapCircle(animator.transform.position, DetectRadius, LayerMask.GetMask("Player"));
        if (hit)
        {
